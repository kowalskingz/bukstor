			...
			<div class="container">
				...
				<div class="col-md-6 col-sm-6">
										...
										<form role="form" action="" method="post">
											...
											<label for="email-login">E-Mail / Username</label>
											<input type="text" id="email-login" class="form-control" name="username">
											</div>
											<div class="form-group">
										...
										<h3>Sign-up</h3>
											...
											<p class="text-muted">Belum Punya Akun? Daftar <b><a  href="<?= base_url(); ?>index.php/home/registrasi">Disini!</a></b></p>
