		...
		<div id="payment-address" class="panel panel-default">
			...
			<form action="" method="post">
				...
				<div class="form-group">
					...
					<input type="text" id="email" class="form-control" name="email" value="<?= $email;?>" readonly="readonly">
				</div>
				<div class="form-group">
				...
				<h3>Your Password</h3>
				<div class="form-group">
					<label for="password">Masukkan Pssword Anda<span class="require">*</span></label>
